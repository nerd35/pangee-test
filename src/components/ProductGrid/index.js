    ...
    <div className="product-wrapper ">
      <div className="container">
        ...
        {data && data.products.map((product, key) => {
          return (
          <div key={key} className=" col-sm-12 col-md-6 col-lg-4 product-item">
            <img
            ...
            <p className="product-item-amount">from ${product.price}</p>
            <button onClick={() => onAddToCart(product)} className=" product-item-btn">
              Add to Cart
            </button>
          </div>)
        })}
